  ...
  return (
    <>
      ...
      <div class="flex justify-between w-full mt-6">
        <img class="w-1/4 h-auto" src="/mobile.png" alt="Image 1" />
        <img class="w-1/4 h-auto" src="/laptop.png" alt="Image 2" />
        <img class="w-1/4 h-auto" src="/table.png" alt="Image 3" />
        <img class="w-1/4 h-auto" src="/growth.png" alt="Image 4" />
      </div>
    </>
  );
};
