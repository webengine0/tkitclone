...
const Header = () => {
  return (
    <>
      <div className="flex justify-between mt-[36px] items-center border border-green-900 2xl:mx-[100px] xl:mx-[60px] lg:mx-[30px] md:mx-[50px] sm:mx-[10px]  ">
        <div className="flex items-center gap-2">
          <img
            className="max-w-[35px] max-h-[27.58px]"
            src="/logo.png"
            alt="logo"
          />
          <div className="text-1logo cursor-default  ">TKIT SOL</div>
          {/* <div></div> */}
        </div>
